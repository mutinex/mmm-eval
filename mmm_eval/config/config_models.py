...
class EvaluatorConfig(BaseModel):
    ...
    response_column: str = Field(
        description="Column name for response variable (target) in the input data"
    )
    revenue_column: str = Field(
        description="Column name for revenue variable in the input data"
    )
